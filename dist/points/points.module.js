...
const points_admin_controller_1 = require("./points.admin.controller");
...
exports.PointsModule = PointsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [points_admin_controller_1.PointsAdminController, points_controller_1.PointsController],
